	...
	return (
		<>
			...
			<Grid className={classes.sponsors}>
				...
				<div style={{width: "100%"}}>
					<a href={"https://www.senahugheslauer.com/?source=abc"} style={{textDecoration: "none", display: "inline-block"}} target={"_blank"} onClick={() => AbcPlatform.trackEvent("sponsor-click", "sena")}>
...
const SponsorInner: React.FC<ISponsorProps> = (props) =>
{
	...
	const track = () =>
	{
		AbcPlatform.trackEvent("sponsor-click", props.sponsor?.url);
	};
