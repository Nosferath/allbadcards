...
abstract class _GameManager<TGameItem>
{
	protected abstract redisPub: RedisConnector;
	protected abstract redisSub: RedisConnector;
	protected abstract gameSockets: GameSockets;

	constructor(server: http.Server)
	{
	}

	protected abstract games: Collection<TGameItem>;

	public async getGame(gameId: string)
	{
		let existingGame: TGameItem | null;
		try
		{
